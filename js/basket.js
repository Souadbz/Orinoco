...
function getPanier() {
    ...
    /*** le panier contient des produits: creation de la partie panier html ***/
        ...
        <td id="total">${teddy.quantity * teddy.price / 100}.00€</td>
            ...
            /*** Boucle for pour récuperer le (s) produit(s)**/
    ...
    function order() {
        ...
        sendOrder.then(async (response) => {
            try {
                ...
                console.log("commande non envoyer, merci de bien remplir le formulaire ")
            }
        })
    }
    /*** API post / appel de la fonction et affichage du produit ***/
    order()
})